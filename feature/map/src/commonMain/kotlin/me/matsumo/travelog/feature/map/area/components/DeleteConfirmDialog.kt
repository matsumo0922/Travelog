...
import me.matsumo.travelog.core.resource.map_area_delete_message
import me.matsumo.travelog.core.resource.map_area_delete_title
...
internal fun DeleteConfirmDialog(
    ...
    AlertDialog(
        ...
        title = {
            Text(text = stringResource(Res.string.map_area_delete_title))
        },
        text = {
            Text(text = stringResource(Res.string.map_area_delete_message, count))
        },
        confirmButton = {
