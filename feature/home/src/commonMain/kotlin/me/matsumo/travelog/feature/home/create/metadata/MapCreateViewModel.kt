        ...
        viewModelScope.launch {
            ...
            if (currentState.iconFile != null) {
                ...
                val uploadResult = suspendRunCatching {
                    storageRepository.uploadMapIcon(currentState.iconFile, userId)
                }
                ...
                // Create image record
                val imageResult = suspendRunCatching {
                    val image = Image(
                ...
                // Note: The image ID is auto-generated by the database, so we can't get it here.
                // For now, we'll store the storage_key directly in the map
                iconImageId = upload.storageKey
            }
